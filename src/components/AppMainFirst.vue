...
<template class="position-relative">
        ...
        <button class="px-4 py-1 current-button">CURRENT SERIES</button>
        
        <div class="contenitore">

            <div class="d-flex flex-wrap">

                <div v-for="fumetto in fumetti" class="single-card">
                    <img :src="fumetto.thumb" alt="">
                    <h6 class="mt-3">{{fumetto.series}}</h6>
                </div>

            </div>

            <div class="text-center">
                <button class="px-4 py-1" type="button">LOAD MORE</button>
            </div>
